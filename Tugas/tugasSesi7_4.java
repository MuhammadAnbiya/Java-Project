...
public class tugasSesi7_4 {
    public static void main(String[] args) {
        ...
        String jawab = "y";
        do {
            String pulangPergi, status, kotaKeberangkatan, kotaTujuan, validasiBerangkat1 = "salah",
                    validasiTujuan1 = "salah";
            int diskonJauh = 0, diskonTNI = 0, hargaHitung, hargaAwal = 0, indexBerangkat = 1, indexTujuan = 1,
                    validasiBerangkat = 0, validasiTujuan = 0, hargaTotal = 0;
                ...
                if (!kotaKeberangkatan.equals(kotaTujuan)){
                    ...
                    if (validasiBerangkat == 0 && validasiTujuan == 0 ) {
                        System.out.println("====================================================" +
                                "\n///Kota berangkat yang anda masukan salah tolong pilih kota sesuai list///" +
                                "\n====================================================" +
                                "\n///Kota tujuan yang anda masukan salah tolong pilih kota sesusai list///");
                    }else {
                        System.out.println("====================================================" +
